...
from doc_hub.core.database import get_session, IndexedFile
from doc_hub.core.search_index_service import INDEX_DIR
...
class SearchService:
    ...
    def perform_search(self, search_text: str, excluded_file_types: set, path_filter: str | None = None, selected_tags: set | None = None) -> list[IndexedFile]:
        session = get_session()
        try:
